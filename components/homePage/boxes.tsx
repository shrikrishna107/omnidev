    ...
    return (
        <div className=''>
            ...
            <div className='flex items-center justify-center gap-10'>
                <div>
                    <div className='border-3 border-black dark:border-white hover:scale-110 h-[500px] w-80 font-serif text-center text-2xl rounded-lg transition duration-250 animate-from-left shadow-xl hover:shadow-gray-600'>
                        ...
                        <div className=' hover:shadow-md hover:shadow-purple-600 transition mt-[121px] animate-text-left'>
                ...
                <div className='border-3 border-black dark:border-white hover:scale-110 h-[500px] w-80 font-serif text-center text-2xl rounded-lg transition duration-250 animate-appearance-in shadow-xl hover:shadow-gray-600'>
                    ...
                    <div className=' hover:shadow-md hover:shadow-purple-600 mt-[113px] animate-appearance-in'>
                        <Button color="secondary" variant="ghost">
                            Explore More
                        </Button>
                    </div>
                ...
                <div className=' border-3 border-black dark:border-white hover:scale-110 h-[500px] w-80 font-serif text-center text-2xl rounded-lg transition duration-250 animate-from-right shadow-xl hover:shadow-gray-600'>
                    ...
                    <div className=' hover:shadow-md hover:shadow-purple-600 mt-[185px] transition animate-text-right'>
                        <Button color="secondary" variant="ghost">
                            Explore More
                        </Button>
                    </div>
